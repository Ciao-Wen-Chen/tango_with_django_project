# Chapter 5
# setting the enviornment variable "DJANGO_SETTINGS_MODULE" to be project's setting file
import os 
os.environ.setdefault('DJANGO_SETTINGS_MODULE',
                      'tango_with_django_project.settings')

import django #import Django models
django.setup() 
...
def add_page(cat,title,url,views=0):
    #if success, return object[0] only; not valid state[1]
